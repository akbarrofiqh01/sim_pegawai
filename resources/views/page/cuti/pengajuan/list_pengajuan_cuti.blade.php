...
@section('title', 'Pengajuan Cuti - SIM Pegawai')
@section('title-content', 'Pengajuan Cuti')
@section('content')
    <div class="card">
            ...
            @can('tombol tambah jabatan')
                <div class="card-options">
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#dinamicModals"
                        data-title="Tambah Pengajuan Cuti" data-href="{{ route('pengajuanCuti.create') }}"
                        class="btn btn-primary btn-sm" title="tambah pengajuan cuti">
        ...
        function hapusConfirm(jabatanCode) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete(`/jabatan/hapusJabatan/${jabatanCode}`, {
                            id: jabatanCode,
                        }, {
                            headers: {
                                'X-CSRF-TOKEN': token
